...
export default function MarketplaceProductGrid({
  ...
  if (products.length === 0) {
    return (
      <div className="py-8">
        <div className="mx-auto rounded-3xl border border-dashed border-slate-300 bg-white p-8 text-center shadow-sm">
  ...
  return (
    <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3 py-8">
